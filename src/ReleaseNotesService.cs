        ...
        private static readonly BundledRelease[] BundledReleases =
        {
            new BundledRelease
            {
                ...
                Notes =
                    ...
                    + "- 파티 로그의 최종 준비 상태가 온전하면 본인을 포함한 인원수를 2인~5인으로 표시하고, 인원수가 확인되지 않으면 파티로 표시합니다.\n"
                    ...
                    + "- 실게임 통계 행이 없거나 수신 표본이 0건이면 RTT와 패킷손실을 모두 로그없음으로 표시하며, 1건 이상이면 별도의 최소 표본 기준 없이 유효한 로그 값을 표시합니다.\n"
